...
public abstract class CustomDrawingParserParser extends Parser {
	static {
	...
	public static class ParseContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterParse(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitParse(this);
			}
		}
	}
	...
	public static class DrawLineContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_drawLine;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterDrawLine(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitDrawLine(this);
			}
		}
	}
	...
	public final DrawLineContext drawLine() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(T__0);
				setState(54);
				_localctx.x1 = doubleTerm();
				setState(55);
				match(T__1);
				setState(56);
				_localctx.y1 = doubleTerm();
				setState(57);
				match(T__1);
				setState(58);
				_localctx.x2 = doubleTerm();
				setState(59);
				match(T__1);
				setState(60);
				_localctx.y2 = doubleTerm();
				setState(61);
				match(T__2);

				final double x1 = _localctx.x1.value;
				final double y1 = _localctx.y1.value;
				final double x2 = _localctx.x2.value;
				final double y2 = _localctx.y2.value;
				_localctx.callStack = new RecRunnable(null) {
					@Override
					public void run() {
				...
				while ((_la & ~0x3f) == 0 && (1L << _la & (1L << T__9 | 1L << T__11 | 1L << T__18)) != 0) {
					{
						...
						switch (_input.LA(1)) {
							case T__9: {
								setState(63);
								_localctx.fg = fg(_localctx.callStack);
								_localctx.callStack = _localctx.fg.callStack;
							}
								break;
							case T__11: {
								setState(66);
								_localctx.lt = lt(_localctx.callStack);
								_localctx.callStack = _localctx.lt.callStack;
							}
								break;
							case T__18: {
								setState(69);
								_localctx.lw = lw(_localctx.callStack);
								_localctx.callStack = _localctx.lw.callStack;
							}
								break;
							default:
								throw new NoViableAltException(this);
	...
	public static class DrawRectangleContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_drawRectangle;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterDrawRectangle(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitDrawRectangle(this);
			}
		}
	}
	...
	public final DrawRectangleContext drawRectangle() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(T__3);
				setState(78);
				_localctx.x = doubleTerm();
				{}
				setState(80);
				match(T__1);
				setState(81);
				_localctx.y = doubleTerm();
				{}
				setState(83);
				match(T__1);
				setState(84);
				_localctx.width = doubleTerm();
				{}
				setState(86);
				match(T__1);
				setState(87);
				_localctx.height = doubleTerm();
				{}
				setState(89);
				match(T__2);

				final double x = _localctx.x.value;
				final double y = _localctx.y.value;
				final double width = _localctx.width.value;
				final double height = _localctx.height.value;
				_localctx.callStack = new RecRunnable(null) {
					@Override
					public void run() {
				...
				while ((_la & ~0x3f) == 0 && (1L << _la & (1L << T__9 | 1L << T__10 | 1L << T__11 | 1L << T__18)) != 0) {
					{
						...
						switch (_input.LA(1)) {
							...
							case T__10: {
								setState(94);
								_localctx.bg = bg(_localctx.callStack);
								_localctx.callStack = _localctx.bg.callStack;
							}
								break;
							case T__11: {
								setState(97);
	...
	public static class DrawRectangleRoundContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_drawRectangleRound;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterDrawRectangleRound(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitDrawRectangleRound(this);
			}
		}
	}
	...
	public final DrawRectangleRoundContext drawRectangleRound() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				final double width = _localctx.width.value;
				final double height = _localctx.height.value;
				final double radius = _localctx.radius.value;
				_localctx.callStack = new RecRunnable(null) {
					@Override
					public void run() {
	...
	public static class DrawCircleContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_drawCircle;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterDrawCircle(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitDrawCircle(this);
			}
		}
	}
	...
	public static class DrawEllipseContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_drawEllipse;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterDrawEllipse(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitDrawEllipse(this);
			}
		}
	}
	...
	public static class DrawArcContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterDrawArc(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitDrawArc(this);
			}
		}
	}
	...
	public final DrawArcContext drawArc() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(T__1);
				setState(210);
				_localctx.myStart = doubleTerm();
				setState(211);
				match(T__1);
				setState(212);
				_localctx.extent = doubleTerm();
				setState(213);
				match(T__1);
				setState(214);
				_localctx.booleanConstant = booleanConstant();
				setState(215);
				match(T__2);
				...
				final double width = _localctx.width.value;
				final double height = _localctx.height.value;
				final double start = _localctx.myStart.value;
				final double extent = _localctx.extent.value;
				final boolean open = _localctx.booleanConstant.value;
				_localctx.callStack = new RecRunnable(null) {
					@Override
					public void run() {
	...
	public static class DrawTextContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_drawText;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterDrawText(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitDrawText(this);
			}
		}
	}
	...
	public final DrawTextContext drawText() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(T__8);
				setState(235);
				_localctx.simpleString = simpleString();
				{}
				setState(237);
				match(T__1);
				setState(238);
				...
				match(T__1);
				setState(244);
				_localctx.horizontalAlignment = horizontalAlignment();
				{}
				setState(246);
				match(T__2);

				final String text = _localctx.simpleString.value;
				final double x = _localctx.x.value;
				final double y = _localctx.y.value;
				final AlignHorizontal alignment = _localctx.horizontalAlignment.alignment;
				_localctx.callStack = new RecRunnable(null) {
					@Override
					public void run() {
	...
	public static class FgContext extends ParserRuleContext {
		...
		public FgContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterFg(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitFg(this);
			}
		}
	}
	...
	public final FgContext fg(RecRunnable inner) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(T__9);
				setState(257);
				_localctx.colorOwn = colorOwn(Transparency.FOREGROUND);

				final ColorOwn newColor = _localctx.colorOwn.value;
				_localctx.callStack = new RecRunnable(_localctx.inner) {
					@Override
					public void run() {
	...
	public static class BgContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterBg(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitBg(this);
			}
		}
	}
	...
	public final BgContext bg(RecRunnable inner) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(T__10);
				setState(261);
				_localctx.colorOwn = colorOwn(Transparency.BACKGROUND);
	...
	public static class ColorOwnContext extends ParserRuleContext {
		...
		public TerminalNode COLOR_OWN_NAME() {
			return getToken(CustomDrawingParserParser.COLOR_OWN_NAME, 0);
		}

		public TerminalNode COLOR_OWN_HEX() {
			return getToken(CustomDrawingParserParser.COLOR_OWN_HEX, 0);
		}

		public ColorOwnContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_colorOwn;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterColorOwn(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitColorOwn(this);
			}
		}
	}
		...
		try {
			...
			switch (_input.LA(1)) {
				case COLOR_OWN_NAME:
					...
					{
						setState(264);
						_localctx.COLOR_OWN_NAME = match(COLOR_OWN_NAME);
						_localctx.value = ColorOwn.forString(_localctx.COLOR_OWN_NAME != null ? _localctx.COLOR_OWN_NAME.getText() : null, _localctx.transparency);
					}
					break;
				case COLOR_OWN_HEX:
					...
					{
						setState(266);
						_localctx.COLOR_OWN_HEX = match(COLOR_OWN_HEX);
						_localctx.value = ColorOwn.forString(_localctx.COLOR_OWN_HEX != null ? _localctx.COLOR_OWN_HEX.getText() : null, _localctx.transparency);
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public static class LtContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterLt(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitLt(this);
			}
		}
	}
	...
	public final LtContext lt(RecRunnable inner) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(T__11);
				setState(271);
				_localctx.lineType = lineType();

				final LineType newLineType = _localctx.lineType.value;
				if (newLineType != null) {
					_localctx.callStack = new RecRunnable(_localctx.inner) {
						@Override
						public void run() {
					...
					_localctx.callStack = _localctx.inner;
				}
	...
	public static class LineTypeContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_lineType;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterLineType(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitLineType(this);
			}
		}
	}
			...
			switch (_input.LA(1)) {
				case T__12:
					enterOuterAlt(_localctx, 1);
					{
						setState(274);
						match(T__12);
						_localctx.value = LineType.SOLID;
					}
					break;
				case T__13:
					enterOuterAlt(_localctx, 2);
					{
						setState(276);
						match(T__13);
						_localctx.value = LineType.DASHED;
					}
					break;
				case T__14:
					enterOuterAlt(_localctx, 3);
					{
						setState(278);
						match(T__14);
						_localctx.value = LineType.DOTTED;
					}
					break;
				case T__15:
					enterOuterAlt(_localctx, 4);
					{
						setState(280);
						match(T__15);
						_localctx.value = LineType.DOUBLE;
					}
					break;
				case T__16:
					enterOuterAlt(_localctx, 5);
					{
						setState(282);
						match(T__16);
						_localctx.value = LineType.DOUBLE_DASHED;
					}
					break;
				case T__17:
					enterOuterAlt(_localctx, 6);
					{
						setState(284);
						match(T__17);
						_localctx.value = LineType.DOUBLE_DOTTED;
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public static class LwContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterLw(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitLw(this);
			}
		}
	}
	...
	public final LwContext lw(RecRunnable inner) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				match(T__18);
				setState(289);
				_localctx.unsignedDoubleConstant = unsignedDoubleConstant();

				final double newLineWidth = _localctx.unsignedDoubleConstant.value;
				_localctx.callStack = new RecRunnable(inner) {
					@Override
					public void run() {
	...
	public static class SimpleStringContext extends ParserRuleContext {
		...
		public TerminalNode SIMPLE_STRING() {
			return getToken(CustomDrawingParserParser.SIMPLE_STRING, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_simpleString;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterSimpleString(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitSimpleString(this);
			}
		}
	}
	...
	public final SimpleStringContext simpleString() throws RecognitionException {
		...
		try {
			...
			{
				setState(292);
				_localctx.SIMPLE_STRING = match(SIMPLE_STRING);
				_localctx.value = (_localctx.SIMPLE_STRING != null ? _localctx.SIMPLE_STRING.getText() : null).substring(1, (_localctx.SIMPLE_STRING != null ? _localctx.SIMPLE_STRING.getText() : null).length() - 1).replace("\\\"", "\"");
			}
		} catch (RecognitionException re) {
			_localctx.exception = re;
			_errHandler.reportError(this, re);
	...
	public static class BooleanConstantContext extends ParserRuleContext {
		...
		public TerminalNode FALSE() {
			return getToken(CustomDrawingParserParser.FALSE, 0);
		}

		public TerminalNode TRUE() {
			return getToken(CustomDrawingParserParser.TRUE, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterBooleanConstant(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitBooleanConstant(this);
			}
		}
	}
	...
	public static class HorizontalAlignmentContext extends ParserRuleContext {
		...
		public TerminalNode LEFT() {
			return getToken(CustomDrawingParserParser.LEFT, 0);
		}

		public TerminalNode CENTER() {
			return getToken(CustomDrawingParserParser.CENTER, 0);
		}

		public TerminalNode RIGHT() {
			return getToken(CustomDrawingParserParser.RIGHT, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_horizontalAlignment;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterHorizontalAlignment(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitHorizontalAlignment(this);
			}
		}
	}
			...
			switch (_input.LA(1)) {
				case LEFT:
					enterOuterAlt(_localctx, 1);
					{
						setState(301);
						match(LEFT);
						_localctx.alignment = AlignHorizontal.LEFT;
					}
					break;
				case CENTER:
					enterOuterAlt(_localctx, 2);
					{
						setState(303);
						match(CENTER);
						_localctx.alignment = AlignHorizontal.CENTER;
					}
					break;
				case RIGHT:
					enterOuterAlt(_localctx, 3);
					{
						setState(305);
						match(RIGHT);
						_localctx.alignment = AlignHorizontal.RIGHT;
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public static class DoubleTermContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_doubleTerm;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterDoubleTerm(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitDoubleTerm(this);
			}
		}
	}
	...
	public final DoubleTermContext doubleTerm() throws RecognitionException {
		...
		try {
			...
			{
				setState(309);
				_localctx.v1 = doubleProduct();
				{}
				_localctx.value = _localctx.v1.value;
				setState(324);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la == T__12 || _la == T__19) {
					{
						...
						switch (_input.LA(1)) {
							case T__19: {
								...
								match(T__19);
								setState(313);
								_localctx.tmp1 = doubleProduct();
								{}
								_localctx.value = _localctx.value + _localctx.tmp1.value;
							}
								break;
							case T__12: {
								setState(317);
								match(T__12);
								setState(318);
								_localctx.tmp2 = doubleProduct();
								{}
								_localctx.value = _localctx.value - _localctx.tmp2.value;
							}
								break;
							default:
								throw new NoViableAltException(this);
	...
	public static class DoubleProductContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_doubleProduct;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterDoubleProduct(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitDoubleProduct(this);
			}
		}
	}
	...
	public static class DoubleValueContext extends ParserRuleContext {
		...
		public TerminalNode WIDTH() {
			return getToken(CustomDrawingParserParser.WIDTH, 0);
		}

		public TerminalNode HEIGHT() {
			return getToken(CustomDrawingParserParser.HEIGHT, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterDoubleValue(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitDoubleValue(this);
			}
		}
	}
			...
			switch (_input.LA(1)) {
				...
				case T__12:
					enterOuterAlt(_localctx, 3);
					{
						...
						setState(350);
						_localctx.unsignedDoubleConstant = unsignedDoubleConstant();
						_localctx.value = -_localctx.unsignedDoubleConstant.value;
					}
					break;
				...
				case T__22:
					enterOuterAlt(_localctx, 5);
					{
						...
						match(T__22);
						setState(357);
						_localctx.doubleTerm = doubleTerm();
						setState(358);
						match(T__2);
						_localctx.value = _localctx.doubleTerm.value;
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public static class UnsignedDoubleConstantContext extends ParserRuleContext {
		...
		public TerminalNode UNSIGNED_DOUBLE_CONSTANT() {
			return getToken(CustomDrawingParserParser.UNSIGNED_DOUBLE_CONSTANT, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_unsignedDoubleConstant;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).enterUnsignedDoubleConstant(this);
			}
		}
		...
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof CustomDrawingParserListener) {
				((CustomDrawingParserListener) listener).exitUnsignedDoubleConstant(this);
			}
		}
	}
	...
	public final UnsignedDoubleConstantContext unsignedDoubleConstant() throws RecognitionException {
		...
		try {
			...
			{
				setState(363);
				_localctx.UNSIGNED_DOUBLE_CONSTANT = match(UNSIGNED_DOUBLE_CONSTANT);
				_localctx.value = Double.parseDouble(_localctx.UNSIGNED_DOUBLE_CONSTANT != null ? _localctx.UNSIGNED_DOUBLE_CONSTANT.getText() : null);
			}
		} catch (RecognitionException re) {
			_localctx.exception = re;
			_errHandler.reportError(this, re);
